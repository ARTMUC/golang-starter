...
// categoryPostGenerated godoc
// @Summary   Creates entity
// @Tags   category crud   
// @Accept    json
// @Produce   json
// @Param	  request body category.CreateDto true "Request data"      
// @Response  201 {object}        category.Model
// @Router    /category [post]
func categoryPostGenerated() {}

// categoryUpdateGenerated godoc
// @Summary   Updates entity
// @Tags   category crud   
// @Accept    json
// @Produce   json
// @Param	   id path string true "id of item"      
// @Param	  request body category.UpdateDto true "Request data"      
// @Response  200 {object}        category.Model
// @Router    /category/:id [put]
func categoryUpdateGenerated() {}

// categoryDeleteGenerated godoc
// @Summary   Deletes entity
// @Tags   category crud   
// @Accept    json
// @Produce   json
...
func categoryDeleteGenerated() {}

// categoryGetGenerated godoc
// @Summary   Returns entity
// @Tags   category crud   
// @Accept    json
// @Produce   json
...
func categoryGetGenerated() {}

// categoryListGenerated godoc
// @Summary   Lists entities
// @Tags   category crud   
// @Accept    json
// @Produce   json
...
// @Param     filter            query string false  "filters eg: name||$eq||ad price||$gte||200"
// @Param     sort            query string false  "filters eg: created_at,desc title,asc"
// @Response  200 {object}        pagination.Output{rows=[]category.Model} 
// @Router    /campaign/crud/:campaign/category [get]
func categoryListGenerated() {}
